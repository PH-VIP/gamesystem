...
class chuizi(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("./chuizi.png").convert_alpha() 
...
def Mam_init(n0):
    ...
    if n0==0:
        ...
        list_map=[
                    ...
                    [11,300,100],[11,48,250],[11,300,400],[11,48,550],[11,300,700],
                    [5,60,900],[5,100,1100],
                    [10,300,1300],[5,20,1300],[5,60,1500],[5,100,1700],[10,400,1700],
                  [7,420,2020], [7,420,2100], [7,420,2180], [7,420,2260], [7,420,2340], [7,420,2420], [7,420,2500],
                    [8,50,2200],[9,50,2300]
                ]
    elif n0==2:
        list_map=[
...
def Collide():
    ...
    for prop1 in player.group_prop:
        if pygame.sprite.collide_rect(player, prop1):
            if prop1.type_sprite==4 and player.key!=0:
                if player.Check_p<9:
